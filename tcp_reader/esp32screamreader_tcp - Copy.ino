...
#define INITIAL_BUFFER_SIZE 2400   // Number of chunks to be buffered before playback starts, configurable
...
#define RAM_BUFFER_CHUNK_COUNT 64  // Number of chunks to be buffered to RAM from psram
                                   // Samples per chunk
